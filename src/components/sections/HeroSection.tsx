...
export function HeroSection() {
  return (
    <section className="w-full pt-15 md:pt-40 py-12 md:py-24 lg:py-35 bg-gradient-to-br from-primary/10 via-background to-accent/10">
      <div className="container px-4 md:px-6">
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
          <div className="flex flex-col justify-center space-y-6 lg:pl-20 xl:pl-24">
