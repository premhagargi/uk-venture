...
import { Loader2, Lightbulb, AlertTriangleIcon } from 'lucide-react';
    ...
    <div className="space-y-8">
      <Card className="shadow-xl">
        <CardHeader>
          ...
          <CardDescription>
            Paste your financial summary below. Our AI will analyze it and provide key insights and potential concerns.
